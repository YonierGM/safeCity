...
export function Categories() {
    const { incidentsCategory, loadingCategories, error, getIncidentsCategory } = useIncidents();
            ...
            renderRow={(cat) => (
                <tr key={cat.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                    ...
                    <td className="px-6 py-4 flex items-center justify-start gap-6">
                        <button title="Ver detalles" className="text-black hover:text-black dark:hover:text-black cursor-pointer">
                            <SlOptionsVertical />
                        </button>
                    </td>
                </tr>
